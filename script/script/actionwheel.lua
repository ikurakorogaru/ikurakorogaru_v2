...
ping.set("actionwheel.pages.hittest", buffer, true)

buffer = ping.get("actionwheel.pages"):newAction()
buffer:setTitle("respawn hittest")
aw.setColor(buffer, vectors.vec(0.85,0.85,0.85), 0.2, true)
buffer:setItem("minecraft:arrow")
buffer:setOnToggle(pings.hittest_respawn)
buffer:setToggled(ping.get("actionwheel.hittest.respawn"))
ping.set("actionwheel.pages.hittest.respawn", buffer, true)
----- setpage -----
